...
**796** skill repos tracked · **415** passed SKILL.md validation · updated daily (last: 2026-09-04)
...
- [📊 Data & Visualization](#-data--visualization) (31)
- [💻 Coding, Review & Architecture](#-coding-review--architecture) (88)
- [🔍 Research & Knowledge](#-research--knowledge) (36)
- [🎨 Design & Media](#-design--media) (42)
- [🌐 Web & Automation](#-web--automation) (47)
- [🤖 Agents & Orchestration](#-agents--orchestration) (185)
- [🎮 Fun & Lifestyle](#-fun--lifestyle) (4)
- [🧰 Other Skills](#-other-skills) (129)

### 📦 Skill Packs & Curations

| Repo | ⭐ | ✓ | Description |
|:--|--:|:-:|:--|
| [anbeime/skill](https://github.com/anbeime/skill) | 6143 | ✅ | 收录最全、更新最快的技能Skills商店：精选原创技能包（涵盖文档处理、内容创作、编程开发、机器学习、自动化工作流），全部打包好可直接安装使用！同时自动抓取GitHub上万个Skills项目，按分类、更新时间、Star数量整理。The most comprehensive and frequently updated AI Agent skill library, featuring curated skill packs across document processing, content creation, programming, machine learning, automated workflows, and many more domains. |
| [EverMind-AI/SkillCorpus](https://github.com/EverMind-AI/SkillCorpus) | 492 |  | Open-source infrastructure that turns scattered SKILL.md files into curated, retrieval-ready agent-skill corpora—with retrieval and evaluation tooling included. |
| [Unclecheng-li/DeepSec](https://github.com/Unclecheng-li/DeepSec) | 386 |  | DeepSec — AI Security Offense & Defense Platform. Shield audits AI-generated code for hallucinated packages, missing safeguards & AI pattern errors in real time. Spear automates authorized penetration testing with 40+ skill packs, from recon to PoC. |
...
| [Dominic789654/awesome-deepseek-harness](https://github.com/Dominic789654/awesome-deepseek-harness) | 220 |  | A curated list of plugins, skills, MCP servers, patch/profile layers, orchestrators & UIs for DeepSeek Harness (DSH). Visualization · PPT · Coding · Agents · Loops (auto-research) and more. #dsh |
| [imsai-sh/awesome-deepseek-harness-plugins](https://github.com/imsai-sh/awesome-deepseek-harness-plugins) | 215 | ✅ | DeepSeek Harness plugin store, marketplace and hub — 11,000+ dsh plugins with search, rankings, install commands and a free public API. DeepSeek Harness 插件市场 / 插件商店：自动收集与格式校验，免费搜索 API。deepseek1024.com |
| [leenkcool/Blue-Whale-Harness](https://github.com/leenkcool/Blue-Whale-Harness) | 191 |  | 🐋 DeepSeek Harness 插件总目录 · The catalog of DSH plugins：1958 个仓库 / 1819 个真插件（Skills · MCP · Tools · UI · Orchestration），中英文搜索、分类筛选、STAR 排序 → leenkcool.github.io |
| [dhicoc/dsh-reverse-skill](https://github.com/dhicoc/dsh-reverse-skill) | 115 | ✅ | Complete reverse-skill (87 SKILL.md) as a DeepSeek Harness (dsh) Cordis plugin — reverse engineering, authorized pentesting and security research skill pack. |
| [Fishquito7/dsh-skill-mcp-panel](https://github.com/Fishquito7/dsh-skill-mcp-panel) | 114 |  | DSH Web UI plugin: skill and MCP management（Web界面的skill/MCP管理工具） |
| [sandbaseai/sandbase-skills](https://github.com/sandbaseai/sandbase-skills) | 111 |  | 88 installable open-source Agent Skills for research, social intelligence, marketing, and business workflows—compatible with Codex, Claude Code, Cursor, Gemini CLI, and DeepSeek Harness. |
| [xiajiajun516/dsh-config-manager](https://github.com/xiajiajun516/dsh-config-manager) | 72 |  | DeepSeek Harness (DSH) backup & restore plugin — export, import, migrate and sync your complete DSH configuration, plugins, MCP servers, skills and workspace. One-click migration to another machine. |
...
| [MichengAI/dsh-skills-manager](https://github.com/MichengAI/dsh-skills-manager) | 29 |  | DSH Skills Manager — 在 DeepSeek Harness 中统一加载并安全管理本机 Agent Skills · Load and safely manage local Agent Skills in DSH |
...
| ✦ [seed-forge/harness-ai-kit](https://github.com/seed-forge/harness-ai-kit) | 21 | ✅ | Package manager for AI agent assets — 42 skills, 5 CLIs, 1 plugin. Skills for AI/LLM agent engineering, eval-driven dev, spec-driven dev, database (MySQL/PG/Redis/Kafka/Mongo/Oracle/NL2SQL), K8s/Docker diagnostics, infra ops (Dify/Nexus/Harbor/SonarQube) & docs/patent. Runtimes: Codex, Claude Code, Cursor, Kiro, DSH. |
...
| [JingHao-Leon/dsh-alpha-desk](https://github.com/JingHao-Leon/dsh-alpha-desk) | 17 | ✅ | Alpha Desk — a deepseek-harness (dsh) skill pack that turns an agent session into a compliance-first AI investment desk: multi-strategy fund backtesting via ai-hedge-fund, a tools/pre-execute risk gate, cron monitoring and thesis memory. 把 dsh 会话变成合规、可复现、可追责的 AI 投研工作台。 |
...
| [liqichen/dsh-plugin-manager](https://github.com/liqichen/dsh-plugin-manager) | 13 |  | DSH 插件管理器:在 DeepSeek Harness 设置面板内嵌 GUI,管理 MCP 服务 / Skills / 内置插件包,改动热生效无需重启 |
...
| Repo | ⭐ | ✓ | Description |
|:--|--:|:-:|:--|
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | 93895 | ✅ | 🎨 Best DeepSeek Harness Design Plugin. The open-source Claude Design alternative. 🖥️ Local-first desktop app. 🖼️ Your coding agent becomes the design engine: prototypes, landing pages, dashboards, slides, images & video — real files, HTML/PDF/PPTX/MP4 export. 🤖 Claude Code / Codex / Cursor / DeepSeek Harness / OpenCode & 20+ CLIs via BYOK. |
...
| [yuc16/PatentRadar](https://github.com/yuc16/PatentRadar) | 58 | ✅ | 专利侵权分析系统 —— 输入专利公开号，产出竞品侵权分析报告；同时打包成 skill，可被任意 agent（dsh, codex, claudecode 等） 调用。 |
...
| [PerryLink/dsh-plugin-guide](https://github.com/PerryLink/dsh-plugin-guide) | 33 | ✅ | Installable DSH bundle: the dsh-plugin-guide plugin-development knowledge base as an on-demand agent skill. Official docs archive (EN/ZH), Cordis primer, 114-repo community archive, 1654 archived Discussions, 20+ battle-tested pitfalls. |
...
| [Tencent/skillhub](https://github.com/Tencent/skillhub) | 16 | ✅ | SkillHub Open API documentation, examples, and DeepSeek Harness plugin |
...
| [mudden2380078550-creator/write-chinese-long-screenplay](https://github.com/mudden2380078550-creator/write-chinese-long-screenplay) | 14 | ✅ | 中文电影与剧集长剧本写作 skill |
...
| [Andiii208/dsh-ultramath](https://github.com/Andiii208/dsh-ultramath) | 12 | ✅ | UltraMath 数学建模竞赛多 Agent 求解 DSH 插件: 5 角色预设 + 33 篇模型库 + 论文模板/审稿脚本随包 + 进度可视化 |
...
| Repo | ⭐ | ✓ | Description |
|:--|--:|:-:|:--|
| ✦ [tt-a1i/archify](https://github.com/tt-a1i/archify) | 45900 | ✅ | Agent skill for beautiful, verifiable architecture, workflow, sequence, data-flow, and lifecycle diagrams—self-contained HTML with motion and crisp export. |
| ✦ [omdsh-dev/dsh-genui](https://github.com/omdsh-dev/dsh-genui) | 400 | ✅ | GenUI for DeepSeek Harness: interactive UI components rendered inline in assistant replies via the dsh-ui fence — layout, charts, plots, forms, quizzes, mermaid, 3D scenes, and an action event loop back to the model. Ships the fence-teaching host plugin, the browser renderer (client half), and the genui skill. |
| [wp-a/nature-academic-search](https://github.com/wp-a/nature-academic-search) | 177 | ✅ | Academic Paper Search：中文科研用户的 Codex / Claude Code / DeepSeek Harness Skill + MCP；跨 CrossRef、PubMed、arXiv、OpenAlex、Europe PMC 检索去重，支持 MeSH、引用核验、引文图谱、试验检索与审计导出。 |
| [Vladimir-Human/humanizer-ru](https://github.com/Vladimir-Human/humanizer-ru) | 122 | ✅ | Нормализация и диагностика русского текста: артефакты копипасты, типографика без правки смысла, детектор связок со статусом домена. Числа — в реестре фактов с эрратой. Не для английского, кода, юрдокументов и художественной прозы |
| [MiaoQichuan/new-litigation-visualization](https://github.com/MiaoQichuan/new-litigation-visualization) | 52 |  | 把法律画出来 · Make the Law Visible —— 给法律人的诉讼可视化工具集：把凌乱的诉讼图重画成能进材料的图，或直接读案件材料画准一张时间轴。Claude Skill / DeepSeek Harness 通用。 |
...
| [GZX2211/dsh-Visual-Workflow](https://github.com/GZX2211/dsh-Visual-Workflow) | 18 | ✅ | 专为 DeepSeek Harness Web GUI 打造的可视化多 Agent 工作流编排插件。公开测试版已上线！接下来会随着 DSH 的正式版上线一并发布正式版！ |
...
| Repo | ⭐ | ✓ | Description |
|:--|--:|:-:|:--|
| ✦ [hyhmrright/brooks-lint](https://github.com/hyhmrright/brooks-lint) | 1446 | ✅ | AI code reviews grounded in 12 classic engineering books — decay risk diagnostics with book citations, severity labels, and 6 analysis modes including full-sweep auto-fix |
...
| [Anionex/dsh-vision-toolkit](https://github.com/Anionex/dsh-vision-toolkit) | 850 | ☑️ | [dsh]为纯文本模型设计更强大的视觉工具箱：一行安装使用、粘贴图片直接识别、多张图片问答、截图到前端UI 还原等｜DeepSeek Harness-native integration for agent-vision-toolkit: image Q&A, long-screenshot OCR, UI restoration, grounding, pixel diff, Artifacts, and Web UI. |
...
| [RealSeaberry/AutoMCM-Pro](https://github.com/RealSeaberry/AutoMCM-Pro) | 216 |  | 全栈式自动数学建模竞赛Skill，支持 Claude Code / Codex / opencode / DeepSeek Harness。AI 担任 Autopilot，人类担任 Copilot；国赛/美赛通用，GitOps 流水线 + 强制代码自证，可选 addons 模块。 |
| [LayneChai/superpowers-dsh](https://github.com/LayneChai/superpowers-dsh) | 120 | ✅ | Superpowers skills for DeepSeek Harness: TDD, debugging, planning, and collaboration skills adapted from obra/superpowers |
| [Vladimir-Human/ru-marketplace-mcp](https://github.com/Vladimir-Human/ru-marketplace-mcp) | 81 | ✅ | Одиннадцать маркетплейсов как MCP-серверы: Wildberries, Ozon, Яндекс Маркет, Детский мир, Авито, AliExpress, Taobao, Мегамаркет, Lamoda, DNS, Ситилинк. Плюс сравнение цен по всем сразу. Только чтение, ключи не нужны. |
| [qkycir-123/dsh-run2skill](https://github.com/qkycir-123/dsh-run2skill) | 65 |  | Automatically turn successful DeepSeek Harness sessions into reusable, reviewable Agent Skills. |
| [fishzjp/qa-skills](https://github.com/fishzjp/qa-skills) | 22 | ✅ | 让 AI 像资深测试工程师一样工作：面向 AI Agent 的测试工程 Skill 框架——10 Skills + 共享知识库 + 类型决策矩阵（Claude Code / dsh 等 Agent 可用） |
...
| [kingselyjoe/video-shotcraft-dsh](https://github.com/kingselyjoe/video-shotcraft-dsh) | 14 | ✅ | 面向 DeepSeek Harness 的电影感产品视频 Agent Skill，包含 152 张镜头配方卡、Remotion 模板、代码组件和音频资产。 |
| [PerryLink/dsh-doublecheck](https://github.com/PerryLink/dsh-doublecheck) | 14 | ✅ | Double-check before you ship: grill the requirements, test the implementation, prove the delivery. An engineering-discipline bundle for DeepSeek Harness. |
...
| [hyqibot/DeepSeek-Harness-Token-Free](https://github.com/hyqibot/DeepSeek-Harness-Token-Free) | 9 |  | A token-free desktop client for the DeepSeek Harness，enjoy！为 DeepSeek Harness (DSH) 生态打造的全免Token费的桌面端 ，极简极易。内置多模态+顶尖工具链能力的大模型 HYQi（Flash / Image / Video）：生图+生视频均免token费，无需API。有疑问可从Readme处二维码进社区交流，需实名钉钉 |
...
| [Wenaixi/dsh-ponytail](https://github.com/Wenaixi/dsh-ponytail) | 6 | ✅ | DSH 完整移植版 DietrichGebert/ponytail — 懒惰 senior 模式，hook注入 |
...
| Repo | ⭐ | ✓ | Description |
|:--|--:|:-:|:--|
| ✦ [titanwings/distilly](https://github.com/titanwings/distilly) | 24322 |  | Distilly — Distill how they think into reusable Skills for any Agent or Bot. Formerly Colleague Skill（原同事 Skill）. |
...
| [LaplaceYoung/dsh-directorx](https://github.com/LaplaceYoung/dsh-directorx) | 19 | ✅ | DirectorX as a DeepSeek Harness plugin: AI video/image/audio skills, knowledge corpus, and configurable vision/image/video/audio model tools. |
...
| [the-thinker0/math-skill](https://github.com/the-thinker0/math-skill) | 10 | ✅ | math-skill：面向 AI 与密码学创新的数学研究操作系统 |
...
| [nullptr-DZF/dsh-academic-research-skills](https://github.com/nullptr-DZF/dsh-academic-research-skills) | 5 | ✅ | (no description) |
| [Qian-Ning/prompt-skill-armory](https://github.com/Qian-Ning/prompt-skill-armory) | 5 |  | Managing prompts，, skills, MCP tools & wallpaper for DeepSeek Harness |
...
| Repo | ⭐ | ✓ | Description |
|:--|--:|:-:|:--|
| ✦ [superdesigndev/superdesign-skill](https://github.com/superdesigndev/superdesign-skill) | 502 | ✅ | The design skill for Claude Code, Cursor and any coding agent. Stop shipping AI-slop UI: turn it into shippable, tasteful frontend. Install: npx skills add superdesigndev/superdesign-skill. Powered by superdesign.dev |
| [kwhi6693-web/photo-abstract-editorial](https://github.com/kwhi6693-web/photo-abstract-editorial) | 93 | ✅ | Turn photos into source-faithful editorial artworks with an Agent Skill — adaptive layouts, controlled abstraction, and a Strict Fidelity composition path. |
...
| ✦ [CheshireJCat/blender](https://github.com/CheshireJCat/blender) | 23 | ✅ | DeepSeek Harness plugin for complete Blender 3D modeling, reconstruction, rendering, validation, and export workflows |
...
| Repo | ⭐ | ✓ | Description |
|:--|--:|:-:|:--|
| [freestylefly/wesight](https://github.com/freestylefly/wesight) | 909 | ✅ | Open-source desktop AI agent workspace with one-click Claude Code, Codex, OpenClaw, Hermes Agent setup and custom LLM model routing. |
| [ningbainb/deepseek-harness-desktop](https://github.com/ningbainb/deepseek-harness-desktop) | 335 |  | Open-source Windows desktop client and GUI for DeepSeek Harness — zero-setup installer with Codex, plugins, skills, SSH, mobile remote access, and 11 skins. |
| [zenstory-ai/oh-story-dsh](https://github.com/zenstory-ai/oh-story-dsh) | 280 |  | A DSH plugin for novel writing and short-drama production, powered by Oh Story and Drama Skills. |
...
| [sagirimo/BioDSH](https://github.com/sagirimo/BioDSH) | 17 |  | The bioinformatics agent desktop for clinicians and wet-lab scientists — built on DeepSeek Harness. One-click installers, a skill store, offline mode. |
...
| [daha1216/dsh-adult-tension](https://github.com/daha1216/dsh-adult-tension) | 15 | ✅ | DeepSeek自带破甲18+互动叙事 Skill：NPC 活人感（有记忆/立场/底线）、数百项素材库、随机开局可预锁、时间推进、全维 YAML 存档。 |
...
| [minivv/dsh-agent-skills](https://github.com/minivv/dsh-agent-skills) | 12 |  | Discover and manage Agent Skills inside DeepSeek Harness |
...
| [xingtu1996/xingtu-skills](https://github.com/xingtu1996/xingtu-skills) | – | ✅ | AI Agent 技能聚合仓：26 个生产级 SKILL.md（跨工具 + DSH 兼容）｜26 production-grade AI agent skills, cross-tool & DeepSeek Harness compatible |
...
| Repo | ⭐ | ✓ | Description |
|:--|--:|:-:|:--|
| [akira399/dsh-godot-skill](https://github.com/akira399/dsh-godot-skill) | 20 |  | Godot Engine 4.x 全栈游戏开发技能插件 for DeepSeek Harness (DSH) — registers the godot-4-development skill at runtime |
...
| Repo | ⭐ | ✓ | Description |
|:--|--:|:-:|:--|
| [zhu1090093659/dsh-web](https://github.com/zhu1090093659/dsh-web) | 6794 |  | DeepSeek Harness (DSH) Web Plugin Aggregation Ecosystem · Everything is a plugin, distributed via the Creative Workshop |
...
| [oh-my-dsh/dsh-plugin-upgrade-skill](https://github.com/oh-my-dsh/dsh-plugin-upgrade-skill) | 35 | ✅ | 帮助插件自动随着dsh版本升级的skill |
| [win4r/deepseek-harness-plugin-creator](https://github.com/win4r/deepseek-harness-plugin-creator) | 33 | ✅ | Reusable Codex skill for building and validating DeepSeek Harness and Cordis plugins |
...
| [jingyunstudio/jingyun-dsh](https://github.com/jingyunstudio/jingyun-dsh) | 13 |  | 基于 Jingyun Studio + DeepSeek Harness (DSH) 打造的一站式 AI 商业化桌面客户端 |
...
| [luxiu666/OmniOps](https://github.com/luxiu666/OmniOps) | 9 | ✅ | (no description) |
...
| [cryjkd/dsh-clawbot](https://github.com/cryjkd/dsh-clawbot) | 6 |  | dsh-clawbot |

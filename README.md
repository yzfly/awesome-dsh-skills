...
**919** skill repos tracked · **508** passed SKILL.md validation · updated daily (last: 2026-09-18)
...
- [📦 Skill Packs & Curations](#-skill-packs--curations) (182)
- [📝 Docs, Writing & Office](#-docs-writing--office) (84)
- [📊 Data & Visualization](#-data--visualization) (38)
...
| [Unclecheng-li/DeepSec](https://github.com/Unclecheng-li/DeepSec) | 433 |  | DeepSec — AI Security Offense & Defense Platform. Shield audits AI-generated code for hallucinated packages, missing safeguards & AI pattern errors in real time. Spear automates authorized penetration testing with 40+ skill packs, from recon to PoC. |
| [Dominic789654/awesome-deepseek-harness](https://github.com/Dominic789654/awesome-deepseek-harness) | 339 |  | A curated list of plugins, skills, MCP servers, patch/profile layers, orchestrators & UIs for DeepSeek Harness (DSH). Visualization · PPT · Coding · Agents · Loops (auto-research) and more. #dsh |
...
| [imsai-sh/awesome-deepseek-harness-plugins](https://github.com/imsai-sh/awesome-deepseek-harness-plugins) | 239 | ✅ | DeepSeek Harness plugin store, marketplace and hub — 11,000+ dsh plugins with search, rankings, install commands and a free public API. DeepSeek Harness 插件市场 / 插件商店：自动收集与格式校验，免费搜索 API。deepseek1024.com |
...
| [dhicoc/dsh-reverse-skill](https://github.com/dhicoc/dsh-reverse-skill) | 146 | ✅ | Complete reverse-skill (87 SKILL.md) as a DeepSeek Harness (dsh) Cordis plugin — reverse engineering, authorized pentesting and security research skill pack. |
| [Fishquito7/dsh-skill-mcp-panel](https://github.com/Fishquito7/dsh-skill-mcp-panel) | 132 |  | DSH Web UI plugin: skill and MCP management（Web界面的skill/MCP管理工具） |
| [PerryLink/dsh-industry-research](https://github.com/PerryLink/dsh-industry-research) | 122 | ✅ | Industry and company research domain pack for DeepSeek Harness: methodology skills, industry chain mapping, public-source policy/news tracking, company research cards, and auditable research reports. Research only - not investment advice. |
...
| [PKUfudawei/dsh-capability-menu](https://github.com/PKUfudawei/dsh-capability-menu) | 85 |  | 一个面向 DeepSeek Harness 的统一能力管理插件，为 Tools/Skills 提供常驻、按需、禁用三档暴露策略，以减少上下文占用并支持运行时动态发现与执行。 |
...
| ✦ [seed-forge/harness-ai-kit](https://github.com/seed-forge/harness-ai-kit) | 24 | ✅ | Package manager for AI agent assets — 42 skills, 5 CLIs, 1 plugin. Skills for AI/LLM agent engineering, eval-driven dev, spec-driven dev, database (MySQL/PG/Redis/Kafka/Mongo/Oracle/NL2SQL), K8s/Docker diagnostics, infra ops (Dify/Nexus/Harbor/SonarQube) & docs/patent. Runtimes: Codex, Claude Code, Cursor, Kiro, DSH. |
...
| [weibaohui/skills-management](https://github.com/weibaohui/skills-management) | 9 |  | DeepSeek Harness 插件：技能市场——安装/删除/详情 API + 管理界面 |
...
| [Crayonnan/dsh-math-modeling-skills-Gatecraft-](https://github.com/Crayonnan/dsh-math-modeling-skills-Gatecraft-) | 6 | ✅ | (no description) |
...
| [01men/ybkk-AIOS](https://github.com/01men/ybkk-AIOS) | 6 | ☑️ | 榕器 · 企业 AI 资源统一管理平台 —— dsh/cordis 插件化（IAM/OIDC/MCP/Skill 市场/Agent/审计/用量计量/模型网关/流程编排/FinOps），按团队+领域资产定价 · 制造业私有化交付项目制，对外只呈现用量透明与内部成本穿透 |
| [BAIKAI23333/dsh-skills-manager](https://github.com/BAIKAI23333/dsh-skills-manager) | 5 |  | 一个方便管理skills的deepseekharness插件 |
...
| [VDERR/echocat-skill-panel-3.0](https://github.com/VDERR/echocat-skill-panel-3.0) | – |  | DSH 技能调用审计 + 应用内 skill 管理器 |
...
| Repo | ⭐ | ✓ | Description |
|:--|--:|:-:|:--|
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | 96779 | ✅ | 🎨 Best DeepSeek Harness Design Plugin. The open-source Claude Design alternative. 🖥️ Local-first desktop app. 🖼️ Your coding agent becomes the design engine: prototypes, landing pages, dashboards, slides, images & video — real files, HTML/PDF/PPTX/MP4 export. 🤖 Claude Code / Codex / Cursor / DeepSeek Harness / OpenCode & 20+ CLIs via BYOK. |
...
| ✦ [linhut/gongwen-skill](https://github.com/linhut/gongwen-skill) | 55 | ✅ | 公文全流程处理工具——基于 GB/T 9704《党政机关公文格式》 国家标准，面向公文写作、企事业单位材料编制场景，支持 格式检查与修复、内容优化（Word 原生修订+批注/差异对比版）、模板生成、Markdown 转公文、版头版记页码注入、事实核验、风格增强 等完整能力。原生支持 DeepSeek Harness (DSH) 技能系统，打包为可被 AI Agent 直接调用的 Skill，完全自包含，克隆即用。 |
...
| [Andiii208/dsh-ultramath](https://github.com/Andiii208/dsh-ultramath) | 26 | ✅ | UltraMath 数学建模竞赛多 Agent 求解 DSH 插件: 5 角色预设 + 33 篇模型库 + 论文模板/审稿脚本随包 + 进度可视化 |
| [PerryLink/dsh-claude-move](https://github.com/PerryLink/dsh-claude-move) | 23 |  | Four-source migration wizard for DeepSeek Harness: move Claude Code, Codex, OpenCode and Hermes sessions, memories, skills, instructions and slash commands into DSH (/move wizard + resumable sessions, approval-gated, idempotent). |
...
| [STARDUSTLC666/dsh-ppt](https://github.com/STARDUSTLC666/dsh-ppt) | 7 | ✅ | DSH 演示文稿技能 + 工具插件：一句话或一篇 Markdown 文档 → 完整演示文稿（独立 HTML 网页放映 + 可编辑 PPTX 导出），内置 5 套视觉主题与页间转场/要点入场动画（motion 可关），可配置默认主题/语言，中英双语，SKILL.md 薄路由 + references 按需装载，跨 harness。 |
...
| [tjxj/dsh-wanghong-handwritten-ppt](https://github.com/tjxj/dsh-wanghong-handwritten-ppt) | 5 | ✅ | 王虹学术手写风 PPT Skill for DeepSeek Harness · Notability-style HTML slides and PNG export |
...
| [bluechonk/skills](https://github.com/bluechonk/skills) | – |  | bluechonk 个人 DeepSeek Harness (DSH) Skills 配置仓库 —— 为 DSH 代理提供可复用的技能扩展 |
...
| Repo | ⭐ | ✓ | Description |
|:--|--:|:-:|:--|
| ✦ [tt-a1i/archify](https://github.com/tt-a1i/archify) | 65873 | ✅ | Agent skill for beautiful, verifiable architecture, workflow, sequence, data-flow, and lifecycle diagrams—self-contained HTML with motion and crisp export. |
| ✦ [omdsh-dev/dsh-genui](https://github.com/omdsh-dev/dsh-genui) | 462 | ✅ | GenUI for DeepSeek Harness: interactive UI components rendered inline in assistant replies via the dsh-ui fence — layout, charts, plots, forms, quizzes, mermaid, 3D scenes, and an action event loop back to the model. Ships the fence-teaching host plugin, the browser renderer (client half), and the genui skill. |
...
| [Vladimir-Human/humanizer-ru](https://github.com/Vladimir-Human/humanizer-ru) | 125 | ✅ | Проверяемая гигиена вставки из чата для русского текста |
...
| [STARDUSTLC666/dsh-remotion](https://github.com/STARDUSTLC666/dsh-remotion) | 8 | ✅ | DSH 视频创作技能插件：注册 Remotion 官方移植技能（React 编程式视频：动画/音频/字幕/3D/图表/字体，38 个规则文件），安装即用。 |
...
| [lxfu1/dsh-plugin-chart](https://github.com/lxfu1/dsh-plugin-chart) | 7 |  | DeepSeek Harness plugin that bundles the AntV chart visualization skill and a native chart-generation tool. |
| [ryubyte/dsh-a2a](https://github.com/ryubyte/dsh-a2a) | 6 |  | DSH 的 A2A v1.0 双端插件:Client 发现远程 Agent 并映射为工具,Server 对外提供 JSON-RPC/SSE 端点与连接面板 ｜ A2A v1.0 dual-mode DSH plugin: A2A client (skills as tools) + A2A server (JSON-RPC/SSE) with dashboard. |
...
| Repo | ⭐ | ✓ | Description |
|:--|--:|:-:|:--|
| ✦ [hyhmrright/brooks-lint](https://github.com/hyhmrright/brooks-lint) | 1482 | ✅ | AI code reviews grounded in 12 classic engineering books — decay risk diagnostics with book citations, severity labels, and 6 analysis modes including full-sweep auto-fix |
| ✦ [GanyuanRan/Aegis](https://github.com/GanyuanRan/Aegis) | 1207 | ✅ | Make AI coding agents architecture-aware: baseline-first, evidence-verified, drift-checked, and safe across long tasks. |
...
| [RealSeaberry/AutoMCM-Pro](https://github.com/RealSeaberry/AutoMCM-Pro) | 249 |  | 全栈式自动数学建模竞赛Skill，支持 Claude Code / Codex / opencode / DeepSeek Harness。AI 担任 Autopilot，人类担任 Copilot；国赛/美赛通用，GitOps 流水线 + 强制代码自证，可选 addons 模块。 |
| [JingHao-Leon/dsh-alpha-desk](https://github.com/JingHao-Leon/dsh-alpha-desk) | 158 | ✅ | 把 dsh 会话变成合规、可复现、可追责的 AI 投研工作台：ai-hedge-fund 回测 + risk-gate 风控 + cron 盯盘 + 记忆复盘 \| compliance-first AI investment desk |
...
| [LayneChai/superpowers-dsh](https://github.com/LayneChai/superpowers-dsh) | 90 | ✅ | Superpowers skills for DeepSeek Harness: TDD, debugging, planning, and collaboration skills adapted from obra/superpowers |
| [PerryLink/dsh-doublecheck](https://github.com/PerryLink/dsh-doublecheck) | 33 | ✅ | Double-check before you ship: grill the requirements, test the implementation, prove the delivery. An engineering-discipline bundle for DeepSeek Harness. |
| [fishzjp/qa-skills](https://github.com/fishzjp/qa-skills) | 32 | ✅ | 让 AI 像资深测试工程师一样工作：面向 AI Agent 的测试工程 Skill 框架——11 Skills + 共享知识库 + 类型决策矩阵（Claude Code / dsh 等 Agent 可用） |
...
| [hyqibot/DeepSeek-Harness-Token-Free](https://github.com/hyqibot/DeepSeek-Harness-Token-Free) | 14 |  | A token-free desktop client for the DeepSeek Harness，enjoy！为 DeepSeek Harness (DSH) 生态打造的全免Token费的桌面端 ，极简极易。内置多模态+顶尖工具链能力的大模型 HYQi（Flash / Image / Video）：生图+生视频均免token费，无需API。有疑问可从Readme处二维码进社区交流，需实名钉钉 |
...
| [Kaiji-Z/dsh-plugin-lookatstudy](https://github.com/Kaiji-Z/dsh-plugin-lookatstudy) | 13 |  | dsh community plugin: turn any markdown/folder/GitHub learning repo into a guided AI-tutor course (gated skill tree, BKT mastery, SM-2 reviews) inside DeepSeek Harness |
| [madage/dsh-self-improved](https://github.com/madage/dsh-self-improved) | 12 |  | DeepSeek Harness long-term memory & self-evolving plugin: L0 capture -> L1 memory extraction -> L2 scene grouping -> L3 user persona, auto recall injection + skill synthesis, fully local. |
...
| [Wenaixi/dsh-ponytail](https://github.com/Wenaixi/dsh-ponytail) | 8 | ✅ | DSH 完整移植版 DietrichGebert/ponytail — 懒惰 senior 模式，hook注入 |
...
| Repo | ⭐ | ✓ | Description |
|:--|--:|:-:|:--|
| ✦ [titanwings/distilly](https://github.com/titanwings/distilly) | 24833 | ✅ | Distilly — Distill how they think into reusable Skills for any Agent or Bot. Formerly Colleague Skill（原同事 Skill）. |
...
| [winsonpong98-cloud/dsh-distillation-director](https://github.com/winsonpong98-cloud/dsh-distillation-director) | – | ✅ | 蒸馏主管：把一本书蒸馏成可执行 Agent 技能（V4.6 · 三闸判态 + §21 强制门禁 + 避坑手册） |
...
| [zenstory-ai/oh-story-dsh](https://github.com/zenstory-ai/oh-story-dsh) | 362 |  | DeepSeek 写网文/小说的工作流插件：DeepSeek Harness 社区插件，内置小说、短剧、游戏、视频解说四个工作台 \| Community DeepSeek Harness plugin with novel, short-drama, game and video-recap workbenches. |
| [kwhi6693-web/photo-abstract-editorial](https://github.com/kwhi6693-web/photo-abstract-editorial) | 102 | ✅ | Turn photos into source-faithful editorial artworks with an Agent Skill — adaptive layouts, controlled abstraction, and a Strict Fidelity composition path. |
...
| [ChantillyAn/wechat-video-skill](https://github.com/ChantillyAn/wechat-video-skill) | 12 | ✅ | WeChat Video Skill —— 教会你的 AI Agent 下载微信视频号视频的 Agent Skill。给链接 → 解密无水印 MP4 → 自动发回微信/飞书。适用于 Claude Code / Codex / Cursor / DSH。 |
| [liangdabiao/ecom-details-image-plugin](https://github.com/liangdabiao/ecom-details-image-plugin) | 10 |  | 把 Skill「ecom-details-image」（电商图片方法论）改造成的 DeepSeek Harness（dsh）插件：让模型在 dsh 里就能写出合规的电商图片 Prompt 并**真实出图**（产品主图 / 详情页 / 社媒图 / 直播场景 / 广告等），结果以画廊卡片展示在网页界面。 ## 一句话实战 ``` 用户：「生成一张白色马克杯的电商主图」 |
...
| [STARDUSTLC666/dsh-hyperframes](https://github.com/STARDUSTLC666/dsh-hyperframes) | 6 | ✅ | DSH 视频创作技能插件：注册 HyperFrames by HeyGen 官方移植技能五件套（hyperframes / hyperframes-cli / hyperframes-registry / website-to-hyperframes / gsap），安装即用。 |
...
| [BlackPearl-AI/BlackPearl-CodingAgent](https://github.com/BlackPearl-AI/BlackPearl-CodingAgent) | 7 |  | BlackPearl — DeepSeek-powered AI agent harness and orchestration ecosystem with 286+ skills, 273+ specialist agents, plugins, security, QA and automation. |
...
| [ningbainb/deepseek-harness-desktop](https://github.com/ningbainb/deepseek-harness-desktop) | 600 |  | Open-source Windows desktop client and GUI for DeepSeek Harness — zero-setup installer with Codex, plugins, skills, SSH, mobile remote access, and 11 skins. |
| [gitroomhq/postiz-agent](https://github.com/gitroomhq/postiz-agent) | 469 | ✅ | Postiz Agents CLI - connect it to Claude / OpenClaw / etc, to schedule social media posts 🤖 |
...
| [zenx0x/allinluna](https://github.com/zenx0x/allinluna) | 58 |  | Resource-aware multi-agent orchestration for Codex and DeepSeek Harness (All in Flash DSH plugin) |
...
| [daha1216/dsh-adult-tension](https://github.com/daha1216/dsh-adult-tension) | 45 | ✅ | DeepSeek 自带破甲 18+ 互动叙事：活人感 NPC（自主决策/拒绝迎合）、52 个世界与上千素材、开局随心定制、世界自行运转、全维 YAML 存档。 |
...
| [techflag/workdsh](https://github.com/techflag/workdsh) | 37 |  | A plugin-based Web work platform built on DeepSeek Harness, with global Skill management and native workspace integration. 基于 DeepSeek Harness 的插件化 Web 工作平台。 |
| [sagirimo/BioDSH](https://github.com/sagirimo/BioDSH) | 36 |  | The bioinformatics agent desktop for clinicians and wet-lab scientists — built on DeepSeek Harness. One-click installers, a skill store, offline mode. |
...
| [ARFCON/dsh-hotplug-hub](https://github.com/ARFCON/dsh-hotplug-hub) | 28 |  | DSH - Dseam |
...
| [hongshuxifan321/plan-first](https://github.com/hongshuxifan321/plan-first) | 19 | ✅ | 先议后行——AI 协作变更任务的议行分离机制 skill（Claude Code / DeepSeek Harness / ZCode 通用） |
...
| [Sivan757/dsh-agent-plugins-market](https://github.com/Sivan757/dsh-agent-plugins-market) | 10 |  | DeepSeek Harness (DSH) plugin marketplace: install & inject Claude Code / Codex / Cursor agent plugins — skills, MCP servers, hooks & slash commands — from git marketplace repos, with a Web GUI market page. |
...
| [hsiaozzz/cocos-creator-skill](https://github.com/hsiaozzz/cocos-creator-skill) | 9 | ✅ | Cocos Creator 3.8.x / COCOS 4 游戏开发 Agent Skill（遵循 Agent Skills 开放标准）。支持 Claude Code · Codex · DeepSeek Harness (dsh) · WorkBuddy · Cursor · Copilot 等 100+ 平台 |
...
| [PeterTXPan/dsh-unreal-mcp](https://github.com/PeterTXPan/dsh-unreal-mcp) | 7 | ✅ | DeepSeek Harness Bundle for Unreal Engine 5.8 via Unreal MCP |
...
| Repo | ⭐ | ✓ | Description |
|:--|--:|:-:|:--|
| [akira399/dsh-godot-skill](https://github.com/akira399/dsh-godot-skill) | 24 |  | Godot Engine 4.x 全栈游戏开发技能插件 for DeepSeek Harness (DSH) — registers the godot-4-development skill at runtime |
...
| Repo | ⭐ | ✓ | Description |
|:--|--:|:-:|:--|
| [zhu1090093659/dsh-web](https://github.com/zhu1090093659/dsh-web) | 7695 |  | DeepSeek Harness (DSH) Web 插件聚合生态 · 万物皆插件，通过创意工坊分发｜｜DeepSeek Harness (DSH) Web Plugin Aggregation Ecosystem · Everything is a plugin, distributed via the Creative Workshop |
| [jingyunstudio/jingyun-dsh](https://github.com/jingyunstudio/jingyun-dsh) | 442 |  | 基于 Jingyun Studio + DeepSeek Harness (DSH) 打造的一站式 AI 商业化桌面客户端，一个将 AI 智能体 / 技能 / 工作流转化为可交易商品的完整商业化平台客户端。 井云为 DSH 注入了完整的商业闭环：登录注册 → 会员体系 → 订阅支付 → 云端资产 → 多端同步，让 AI 开发者 30 分钟内将自己的智能体封装为独立的商业产品。 |
...
| [win4r/deepseek-harness-plugin-creator](https://github.com/win4r/deepseek-harness-plugin-creator) | 39 | ✅ | Reusable Codex skill for building and validating DeepSeek Harness and Cordis plugins |
...
| [a735624258/dsh-skill-picker](https://github.com/a735624258/dsh-skill-picker) | 28 |  | DSH 实现 workbuddy 同款选择 skill 功能 \| WorkBuddy-style skill picker for DeepSeek Harness: pick a skill in the composer, insert the official /skill-name gesture, and DSH loads it with your message. |
...
| [luxiu666/OmniOps](https://github.com/luxiu666/OmniOps) | 10 | ✅ | (no description) |
...
| [adoresever/baimiao](https://github.com/adoresever/baimiao) | 7 | ✅ | 把一段中文，改出人写的分寸和文采。 |
...
| [lhwu1/dsh-withskillhub](https://github.com/lhwu1/dsh-withskillhub) | 6 |  | 携手skillhub，快捷安装启用丰富的skill，一键装配方便快捷。 |
| [gosomea/dsh-godot-ai](https://github.com/gosomea/dsh-godot-ai) | 6 | ✅ | 对gotdot-ai以及一些godot-skill的封装的 deepseek harness插件 |
...
| [tianq520/dsh-hanli-unlock](https://github.com/tianq520/dsh-hanli-unlock) | 5 | ✅ | DSH 韩立破甲一键部署包 — persona 注入 + 安全限制解除 + 攻伐 skills + FOFA MCP |

...
**713** skill repos tracked · **385** passed SKILL.md validation · updated daily (last: 2026-08-25)
...
| [Fishquito7/dsh-skill-mcp-panel](https://github.com/Fishquito7/dsh-skill-mcp-panel) | 97 |  | DSH Web UI plugin: skill and MCP management（Web界面的skill/MCP管理工具） |
...
| [isPirate/dsh-skill-mcp-manager](https://github.com/isPirate/dsh-skill-mcp-manager) | – |  | dsh管理Skill和MCP的插件 |
...
| [KuramiWan/dshp-skill-panel](https://github.com/KuramiWan/dshp-skill-panel) | – |  | 为DeepSeekHarness开发的会话级插件管理面板，支持模型工具，斜杠命令，浏览器可视化面板管理你的插件（或者skills，mcp）\| Session-scoped skill control for DeepSeek Harness — model tools, slash commands, and a browser Skill Panel over one shared skill store. |
...
| [lxfu1/dsh-plugin-chart](https://github.com/lxfu1/dsh-plugin-chart) | – |  | Community DeepSeek Harness plugin that bundles the AntV chart visualization skill and a native chart-generation tool. |
...
| [kingselyjoe/video-shotcraft-dsh](https://github.com/kingselyjoe/video-shotcraft-dsh) | 5 | ✅ | 面向 DeepSeek Harness 的电影感产品视频 Agent Skill，包含 152 张镜头配方卡、Remotion 模板、代码组件和音频资产。 |
...
| [madage/dsh-self-improved](https://github.com/madage/dsh-self-improved) | 5 |  | DeepSeek Harness long-term memory & self-evolving plugin: L0 capture -> L1 memory extraction -> L2 scene grouping -> L3 user persona, auto recall injection + skill synthesis, fully local. |
...
| [STARDUSTLC666/dsh-remotion](https://github.com/STARDUSTLC666/dsh-remotion) | – | ✅ | DSH 视频创作技能插件：注册 Remotion 官方移植技能（React 编程式视频，38 个规则文件），安装即用。· Remotion skill plugin for DeepSeek Harness. |
...
| [ruby898/wechat-draft-publisher](https://github.com/ruby898/wechat-draft-publisher) | – | ✅ | 微信公众号文章一键发布到草稿箱skill：本地Markdown 文章一键进草稿箱，排版自动套用。Codex / Claude Code / DeepSeek Harness 三生态通用。 |
...
| [pazz11/Jnpz](https://github.com/pazz11/Jnpz) | 11 |  | 改配置+重启才能加 MCP？DeepSeek Harness (DSH) 插件「技能配置」解决：设置页粘贴 JSON 即连 MCP 服务器、热加载免重启；上传 zip/.skill 自动识别 SKILL.md，创建/编辑/启停技能，即点即用 |
...
| [daha1216/dsh-adult-tension](https://github.com/daha1216/dsh-adult-tension) | 8 | ✅ | DeepSeek Harness 成年人(18+/adult)互动叙事 Skill：NPC 活人感（有记忆/立场/底线）、自带破甲、数百项素材库、随机开局可预锁、时间推进、全维 YAML 存档。 |
...
| [minivv/dsh-agent-skills](https://github.com/minivv/dsh-agent-skills) | 7 |  | Discover and manage Agent Skills inside DeepSeek Harness |
...
| [Diluka/dsh-agent-plugin-market](https://github.com/Diluka/dsh-agent-plugin-market) | – |  | DSH（DeepSeek Harness）插件：以 git 仓库为 agent 插件市场，安装并原地加载 Codex/Claude 格式的技能 |
...
| [Seasonswind/free-eyes-for-deepseek-harness](https://github.com/Seasonswind/free-eyes-for-deepseek-harness) | – | ✅ | Free eyes for text-only AI agents: DeepSeek Harness skill + MCP server, Gemini |
...
| [brianwang2007xjtu/dsh-memory-evolve](https://github.com/brianwang2007xjtu/dsh-memory-evolve) | – |  | Empowers DeepSeek Harness AI with cross-session long-term memory, manages your to-dos and skills, and orchestrates multiple AI sessions and external agents to collaborate—it learns from you over time, so context stays intact even when you switch conversations. |
| [SrSunny1/save-token-skills](https://github.com/SrSunny1/save-token-skills) | – |  | 一组通用、可跨 agent 复用的技能集。把打磨好的「方法」沉淀成开源技能，任何 agent（Claude Code、Codex、DeepSeek Harness 等）都能装上直接用。四个技能串成一条线：/start 进入项目 → /modify＋/questions 展开任务 → /summarize 收尾 → 下次 /start 复盘。 |
...
| [ngaiho/dsh-wechat-channel](https://github.com/ngaiho/dsh-wechat-channel) | – | ✅ | DeepSeek Harness 微信接入加固套件：运维 skill + 健康检查/守护脚本 + im-channel 可靠性补丁（官方 iLink 协议，扫码即用） |
...
| [a735624258/dsh-skill-picker](https://github.com/a735624258/dsh-skill-picker) | 23 |  | DSH 实现 workbuddy 同款选择 skill 功能 \| WorkBuddy-style skill picker for DeepSeek Harness: pick a skill in the composer, insert the official /skill-name gesture, and DSH loads it with your message. |
...
| [PKUfudawei/dsh-capability-menu](https://github.com/PKUfudawei/dsh-capability-menu) | 14 |  | Unified capability menu for DeepSeek Harness: manage exposure level (context footprint) and execution mode of MCP tools & skills via Exposed/Progressive/Blocked tiers. |
...
| [Max-Null/dsh-skill-mcp-center](https://github.com/Max-Null/dsh-skill-mcp-center) | – |  | (no description) |
...
| [Cooper3516833584/vision-skill-for-deepseek-harness](https://github.com/Cooper3516833584/vision-skill-for-deepseek-harness) | – | ✅ | (no description) |

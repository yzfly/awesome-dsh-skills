...
- [Anionex/dsh-vision-toolkit](https://github.com/Anionex/dsh-vision-toolkit) ☑️ ⭐821 - [dsh]为纯文本模型设计更强大的视觉工具箱：一行安装使用、粘贴图片直接识别、多张图片问答、截图到前端UI 还原等｜DeepSeek Harness-native integration for agent-vision-toolkit: image Q&A, long-screenshot OCR, UI restoration, grounding, pixel diff, Artifacts, and Web UI.
...
- [LaplaceYoung/dsh-directorx](https://github.com/LaplaceYoung/dsh-directorx) ☑️ ⭐13 - DirectorX as a DeepSeek Harness plugin: AI video/image/audio skills, knowledge corpus, and configurable vision/image/video/audio model tools.
